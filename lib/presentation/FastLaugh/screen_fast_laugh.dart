...
import 'package:netflix/presentation/FastLaugh/widget/video_list_item.dart';
         ...
         return const Center(
            ...
            return PageView(
              ...
              children: List.generate(state.videosList.length, (index) {
                return VideoListItemInheritedWidget(widget: VideoListItem(key:Key(index.toString()), index: index), movieData: state.videosList[index],);
              }),
            );
          }
        },
